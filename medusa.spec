...
Medusa jest oprogramowaniem pozwalającym szybko znaleźć odpowiednie
typy plików w twoim systemie używając indeksu.
...
Pakiet zawiera pliki nagłówkowe dla medusy.
